...
}:
{
  ...
  vize-darwin-arm64 = {
    ...
    version = "v0.424.1";
    src = fetchurl {
      url = "https://github.com/ubugeeei-prod/vize/releases/download/v0.424.1/vize-aarch64-apple-darwin.tar.gz";
      sha256 = "sha256-XywY/Y50h6dwlpY4UvTSKqCThtmTmo9LHstXwkEKlqE=";
    };
  };
}
